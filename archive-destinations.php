<?php
/**
 * The template for displaying archive pages for servicios
 *
 * @package WPTBT
 */

// Modificar la consulta principal para mostrar servicios en orden descendente
...
$archive_title = get_theme_mod('services_archive_title', __('Our Services', 'wptbt-services'));
...
<script type="application/ld+json">
{
    ...
    "url": "<?php echo esc_url(get_post_type_archive_link('servicio')); ?>",
    "publisher": {
        "@type": "Organization",
...
<main id="primary" class="site-main" itemscope itemtype="https://schema.org/WebPage">
    ...
    <!-- Filtro de categorías de servicios (opcional) -->
    <?php if (get_theme_mod('show_service_filters', true)) : ?>
        <?php
        // Obtener categorías de servicios (si estás utilizando taxonomías)
    ...
    <section class="services-list py-12 md:py-16 bg-white" aria-label="<?php esc_attr_e('Services List', 'wptbt-services'); ?>">
        <div class="container mx-auto px-4">
            <!-- Schema.org para la lista de servicios - SEO Improvement -->
            <script type="application/ld+json">
            {
                "@context": "https://schema.org",
                "@type": "ItemList",
...
document.addEventListener('DOMContentLoaded', function() {
    // Sistema de filtrado de servicios por categoría - mejorado para SEO
    ...
    function updateMetaInfo(category) {
        ...
        if (category && category !== 'todos') {
            ...
            if (metaDesc) {
                const categoryDesc = `Descubre nuestros servicios de ${categoryName} diseñados para brindar una experiencia excepcional de relajación y bienestar en Cusco.`;
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', function(e) {
            ...
            announcement.textContent = `${resultCount} servicios mostrados`;
...
.pagination .page-numbers {
    ...
    border-radius: 50%;
    margin: 0 5px;
    background-color: #fef3c7; /* amber-50 equivalent */
    color: #92400e; /* amber-700 equivalent */
    font-weight: 500;
    transition: all 0.3s ease;
    text-decoration: none;
    position: relative; /* Para elementos sr-only */
    border: 1px solid #fbbf24; /* amber-400 equivalent */
}

.pagination .page-numbers:hover {
    background-color: #d97706; /* amber-600 equivalent */
    color: white;
    border-color: #d97706;
}
