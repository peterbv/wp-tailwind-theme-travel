...
/**
 * Plantilla del encabezado mejorada para el sitio spa
 */
...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site max-w-full overflow-x-hidden">
        ...
        <?php if (get_theme_mod('show_topbar', true)) : ?>
            <div class="topbar py-2 text-sm border-b border-gray-100 bg-spa-secondary text-spa-primary transition-all duration-300<?php echo esc_attr($topbar_class); ?>">
                <div class="container mx-auto px-4 flex flex-wrap justify-between items-center">
                    <div class="topbar-left flex items-center gap-4">
                        ...
                        ?>
                            <a href="mailto:<?php echo esc_attr($contact_email); ?>" class="inline-flex items-center hover:text-spa-accent transition duration-300" aria-label="Email de contacto">
                        ...
                        <?php if ($contact_phone = get_theme_mod('contact_phone')) : ?>
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', $contact_phone)); ?>" class="inline-flex items-center hover:text-spa-accent transition duration-300" aria-label="Teléfono de contacto">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="topbar-right flex items-center">
                        <div class="mr-6 hidden sm:flex items-center">
                            <?php if ($business_hours = get_theme_mod('business_hours', 'Everyday: From 10 AM to 10 PM')) : ?>
                                <span class="inline-flex items-center">
                                    <svg class="w-4 h-4 mr-1 text-spa-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="social-icons flex gap-3">
                            ...
                            ?>
                                    <a href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener noreferrer"
                                        class="text-spa-primary hover:<?php echo esc_attr($data['hover']); ?> transition duration-300"
                ...
                <div class="py-4 flex flex-wrap justify-between items-center">
                            ...
                            <div class="site-title">
                                <a href="<?php echo esc_url(home_url('/')); ?>" class="text-2xl fancy-text font-bold flex items-center" rel="home">
                                    <?php if ($logo_text = get_theme_mod('logo_text')): ?>
                                        <span class="text-[#424242]"><?php echo esc_html($logo_text); ?></span>
                                    <?php else: ?>
                                        <span class="text-[#424242]"><?php bloginfo('name'); ?></span>
                                    <?php endif; ?>
                    ...
                    <?php if (get_theme_mod('show_search', true)) : ?>
                        <div class="search-button hidden md:flex items-center mr-4">
                            <button id="search-toggle" class="p-1 text-spa-primary hover:text-spa-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-spa-accent" aria-label="Buscar" aria-expanded="false">
                        ...
                        <?php if (get_theme_mod('show_cta_button', true)) : ?>
                            <div class="ml-8">
                                <a href="<?php echo esc_url(get_theme_mod('cta_button_url', '#')); ?>"
                                    class="inline-block px-6 py-2 bg-spa-accent text-white font-medium rounded-sm hover:bg-opacity-90 transition duration-300 transform hover:-translate-y-0.5 hover:shadow-md<?php echo esc_attr($cta_button_class); ?>">
                                    <?php echo esc_html(get_theme_mod('cta_button_text', 'RESERVAR AHORA')); ?>
                                </a>
                            </div>
                        <?php endif; ?>
                    </nav><!-- #site-navigation -->
                    ...
                    <div class="md:hidden flex items-center">
                        ...
                        <?php if (get_theme_mod('show_search', true)) : ?>
                            <button id="mobile-search-toggle" class="p-2 text-spa-primary hover:text-spa-accent focus:outline-none mr-1" aria-label="Buscar">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                            </button>
                        ...
                        <button id="mobile-menu-toggle" class="flex md:hidden p-2 text-spa-primary hover:text-spa-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-spa-accent transition-all duration-300" aria-label="Menú" aria-expanded="false" aria-controls="mobile-menu">
                ...
                <div id="search-modal" class="hidden search-modal absolute top-full left-0 right-0 bg-white shadow-lg border-t border-gray-100 py-4 px-4 z-50 opacity-0 transform -translate-y-4 transition-all duration-300">
                    <div class="container mx-auto">
                        <form role="search" method="get" class="search-form relative" action="<?php echo esc_url(home_url('/')); ?>">
                            ...
                            <input type="search" id="search-input" class="search-field w-full p-3 pr-10 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-spa-accent" placeholder="<?php echo esc_attr_x('Buscar...', 'placeholder', 'wp-tailwind-theme'); ?>" value="<?php echo get_search_query(); ?>" name="s" />
                            <button type="submit" class="search-submit absolute right-3 top-1/2 transform -translate-y-1/2 text-spa-primary hover:text-spa-accent" aria-label="<?php echo esc_attr_x('Buscar', 'submit button', 'wp-tailwind-theme'); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                            </button>
            ...
            <div id="mobile-menu" class="hidden opacity-0 md:hidden bg-white border-t border-gray-100 transition-all duration-300 transform origin-top">
                <div class="container mx-auto px-4 py-3">
                    ...
                    if (has_nav_menu('primary')) {
                        ...
                        echo '<ul class="mobile-menu-items"><li><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="block py-2 text-gray-600 hover:text-spa-accent">Añadir menú</a></li></ul>';
                    }
                    ?>
                    ...
                    <?php if (get_theme_mod('show_cta_button', true)) : ?>
                        <div class="mt-6 pb-2">
                            <a id="book_now_botton" href="<?php echo esc_url(get_theme_mod('cta_button_url', '#')); ?>" class="block w-full px-6 py-3 bg-spa-accent text-white font-medium text-center rounded-sm hover:bg-opacity-90 transition duration-300 transform hover:-translate-y-0.5">
                                <?php echo esc_html(get_theme_mod('cta_button_text', 'RESERVAR AHORA')); ?>
                            </a>
                        </div>
                    <?php endif; ?>
